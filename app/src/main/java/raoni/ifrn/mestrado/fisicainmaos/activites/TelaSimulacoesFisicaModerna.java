...
public class TelaSimulacoesFisicaModerna extends TabActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        intentTelaSimulacoesFisicaModerna = new Intent().setClass(getApplicationContext(), TelaSimulacaoFisicaModerna1.class);

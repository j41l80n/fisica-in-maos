...
public class BiografiasActivity extends FragmentActivity
{
    ...
    private void steven()
    {
        fisicoSteven.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intentTelaBiografias = new Intent(getApplicationContext(), BiografiaStevenActivity.class);
                startActivity(intentTelaBiografias);
            }
        });
    }
    ...
    private void torricelli()
    {
        fisicoTorricelli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intentTelaBiografias = new Intent(getApplicationContext(), BiografiaTorricelliActivity.class);
                startActivity(intentTelaBiografias);
            }
        });
    }

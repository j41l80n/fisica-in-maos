...
public class SimulacoesMagnetismoActivity extends TabActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        intentTelaSimulacoesMagnetismo = new Intent().setClass(getApplicationContext(), SimulacaoMagnetismo1Activity.class);
        spec = tabHost.newTabSpec("Faradays Law").setIndicator("Faradays Law").setContent(intentTelaSimulacoesMagnetismo);
        tabHost.addTab(spec);

        intentTelaSimulacoesMagnetismo = new Intent().setClass(getApplicationContext(), SimulacaoMagnetismo2Activity.class);
